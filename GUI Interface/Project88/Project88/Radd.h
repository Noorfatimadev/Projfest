...
namespace Project88 {
	...
	/// Summary for Radd
	/// </summary>
	public ref class Radd : public System::Windows::Forms::Form
	{
	public:
		Radd(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Radd::typeid));
			...
			this->label1->Size = System::Drawing::Size(378, 66);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Add Resources";
			// 
			// label2
			// 
			this->label2->AutoSize = true;
			this->label2->BackColor = System::Drawing::Color::Transparent;
			this->label2->Location = System::Drawing::Point(85, 190);
			this->label2->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(188, 39);
			this->label2->TabIndex = 1;
			this->label2->Text = L"Add Resource ID";
			// 
			// label3
			// 
			this->label3->AutoSize = true;
			this->label3->BackColor = System::Drawing::Color::Transparent;
			this->label3->Location = System::Drawing::Point(85, 261);
			this->label3->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(224, 39);
			this->label3->TabIndex = 2;
			this->label3->Text = L"Add Resource Name";
			this->label3->Click += gcnew System::EventHandler(this, &Radd::label3_Click);
			// 
			// textBox1
			// 
			this->textBox1->Font = (gcnew System::Drawing::Font(L"Agency FB", 8, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->textBox1->Location = System::Drawing::Point(417, 261);
			this->textBox1->Margin = System::Windows::Forms::Padding(4, 6, 4, 6);
			this->textBox1->Name = L"textBox1";
			this->textBox1->Size = System::Drawing::Size(319, 26);
			this->textBox1->TabIndex = 4;
			this->textBox1->TextChanged += gcnew System::EventHandler(this, &Radd::textBox1_TextChanged);
			// 
			// textBox2
			// 
			this->textBox2->Font = (gcnew System::Drawing::Font(L"Agency FB", 8, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->textBox2->Location = System::Drawing::Point(417, 203);
			this->textBox2->Margin = System::Windows::Forms::Padding(4, 6, 4, 6);
			this->textBox2->Name = L"textBox2";
			this->textBox2->Size = System::Drawing::Size(319, 26);
			this->textBox2->TabIndex = 5;
			this->textBox2->TextChanged += gcnew System::EventHandler(this, &Radd::textBox2_TextChanged);
			// 
			// button1
			// 
			...
			this->button1->Location = System::Drawing::Point(92, 384);
			this->button1->Margin = System::Windows::Forms::Padding(4, 6, 4, 6);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(644, 63);
			this->button1->TabIndex = 6;
			this->button1->Text = L"Enter";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &Radd::button1_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &Radd::button3_Click);
			// 
			// button4
			// 
			...
			this->button4->Location = System::Drawing::Point(868, 384);
			this->button4->Name = L"button4";
			this->button4->Size = System::Drawing::Size(216, 89);
			this->button4->TabIndex = 45;
			this->button4->Text = L"End";
			this->button4->UseVisualStyleBackColor = false;
			this->button4->Click += gcnew System::EventHandler(this, &Radd::button4_Click);
			// 
			// Radd
			// 
			...
			this->ClientSize = System::Drawing::Size(1188, 498);
			...
			this->Name = L"Radd";
			this->Text = L"Radd";
			this->Load += gcnew System::EventHandler(this, &Radd::Radd_Load);
			this->ResumeLayout(false);
			this->PerformLayout();

		}
#pragma endregion
	private: System::Void Radd_Load(System::Object^ sender, System::EventArgs^ e) {
	}
	private: System::Void label3_Click(System::Object^ sender, System::EventArgs^ e) {
	}
private: System::Void textBox2_TextChanged(System::Object^ sender, System::EventArgs^ e) {
	resource1.set_id(marshal_as<std::string>(textBox2->Text));
}
private: System::Void textBox1_TextChanged(System::Object^ sender, System::EventArgs^ e) {
	resource1.set_name(marshal_as<std::string>(textBox1->Text));
}
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	resource1.add_data();
	MessageBox::Show("Data successfully stored in File");
